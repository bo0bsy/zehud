...
"Resource/UI/HudDemomanPipes.res"
{
	...
	"BuildingStatusHealthImageBG"	{	"wide"	"0"	"visible"	"0"	"enabled"	"0"	}
	"PlayerStatusHealthValueTargetID"	{	"wide"	"0"	"visible"	"0"	"enabled"	"0"	}
	"PlayerStatusHealthValueTargetIDBlur"	{	"wide"	"0"	"visible"	"0"	"enabled"	"0"	}
	...
	"ChargeLabelBig"	{	"wide"	"0"	"visible"	"0"	"enabled"	"0"	}
	"IndividualChargesLabel"	{	"wide"	"0"	"visible"	"0"	"enabled"	"0"	}
	"ChargeLabelBigShadow"	{	"wide"	"0"	"visible"	"0"	"enabled"	"0"	}
	...
	"ChargeMeter"
	{	
		"xpos"	"cs-0.5"	"ypos"	"cs-0.5+10"	"zpos"	"2"	"wide"	"30"	"tall"	"3"			
		"xpos_minmode"	"cs-0.5"	"ypos_minmode"	"cs-0.5+10"	"wide_minmode"	"30"	"tall_minmode"	"3"			
		"proportionaltoparent"	"1"
		"fgcolor_override"	"White"	"bgcolor_override"	"CustomBlack"			
	}	
}